...
def main():
  ugrammar = parse_fcfg("""
  S -> NP[AGR=?a] VP[AGR=?a, FORM=Pres] | Wh SQ | AP S | SQ
  SQ -> Verb[AGR=?a, SUBCAT=Clause] NP[AGR=?a] VP[FORM=Inf]
  ...
  Verb[AGR=[NUM=sg, PER=3], FORM=Pres, SUBCAT=Clause] -> 'does'
  ...
  does Wallace eat cheese
  does Gromit eats cheese
  knows Gromit eat cheese
  Gromit eats the tasty cheese
  Gromit eats tasty the cheese"""
